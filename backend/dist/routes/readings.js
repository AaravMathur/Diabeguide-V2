...
const getStartOfWeekDateString = (localDateStr) => {
...
router.get("/daily-trends", async (req, res) => {
    try {
        ...
        const slots = [
            { time: "6 AM", hourMin: 5, hourMax: 8, values: [] },
            { time: "9 AM", hourMin: 8, hourMax: 11, values: [] },
            { time: "12 PM", hourMin: 11, hourMax: 14, values: [] },
            { time: "3 PM", hourMin: 14, hourMax: 17, values: [] },
            { time: "6 PM", hourMin: 17, hourMax: 20, values: [] },
            { time: "9 PM", hourMin: 20, hourMax: 23, values: [] },
        ];
